...
// Regla 11 - CORREGIDO: se centraliza la orquestación en un método genérico privado.
// Regla 25/26 - CORREGIDO: se descomprime la cadena de llamadas en pasos nombrados.
// Regla 3  - CORREGIDO: cada método tiene un solo nivel de abstracción.
// Regla 6  - CORREGIDO: se elimina el parámetro booleano sendNotificationWithFlag.
@Log
...
public final class EmailNotificationService {
    ...
    // Regla 11 - CORREGIDO: método genérico que centraliza la orquestación.
    // Antes se duplicaba loadTemplate → renderTemplate → buildDestination → send en cada método.
    ...
    // Regla 4 - CORREGIDO: método privado sin estado de instancia declarado como static.
    ...
    // Regla 7 - CORREGIDO: el nombre "sendOrFail" comunica claramente lo que hace:
    // envía o lanza excepción. No hay efectos ocultos adicionales.
