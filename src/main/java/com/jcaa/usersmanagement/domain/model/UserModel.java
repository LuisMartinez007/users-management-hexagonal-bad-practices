...
// Regla 1 - CORREGIDO: Se eliminó la dependencia a UserEntity (infraestructura).
// Regla 2 - CORREGIDO: Se usa @Value en lugar de @Data para garantizar inmutabilidad.
// Regla 15 - CORREGIDO: El modelo de dominio ahora es inmutable (sin setters).
@Value
@AllArgsConstructor
