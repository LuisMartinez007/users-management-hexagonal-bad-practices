...
// Regla 4 - CORREGIDO: Se eliminó el import con wildcard java.sql.* y java.util.*
@Log
...
public final class UserRepositoryMySQL
    ...
    public UserModel saveWithFields(
            ...
            final String password, final String role, final String status) {
        if (id == null || name == null || email == null
                || password == null || role == null || status == null) {
