...
// Regla 1/9 - CORREGIDO: El entrypoint delega al mapper para construir commands y queries.
// El controller ya no conoce los tipos internos de la capa de aplicación directamente.
...
public final class UserController {
    ...
    public UserResponse createUser(final CreateUserRequest request) {
        // Regla 9 - CORREGIDO: se usa el mapper en lugar de construir el command directamente.
